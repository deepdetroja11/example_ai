                        ...
                        <div class="card-body px-4 py-5 px-md-5">
                            <form method="POST" id="userForm">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        <div data-mdb-input-init class="form-outline">
                                            <label class="form-label" for="form3Example1">First name<span
                                                    class="text-danger">*</span></label>
                                            <input type="text" id="form3Example1" name="firstname"
                                                class="form-control" />
                                            <div class="text-danger mt-1 validation-error" id="error-firstname"></div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-4">
                                        <div data-mdb-input-init class="form-outline">
                                            <label class="form-label" for="form3Example2">Last name<span
                                                    class="text-danger">*</span></label>
                                            <input type="text" id="form3Example2" name="lastname"
                                                class="form-control" />
                                            <div class="text-danger mt-1 validation-error" id="error-lastname"></div>
                                        </div>
                                    </div>
                                </div>
                               ...
                               <div class="d-flex justify-content-between align-items-center mb-4">
                                    ...
                                    <span>
                                        Already account? <a href="{{ route('get.signin.form') }}">Sign in</a>
                                    </span>
                                </div>
                            </form>
                        </div>
