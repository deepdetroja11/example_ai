    ...
    <div class="app-container">
        ...
        <div class="result-card" id="resultSection" style="display: none;">
            <div class="success-message">
                ...
                <span>Photo Enhance successfully! Download your image below.</span>
            </div>
            ...
            <div class="comparison-container">
                ...
                <div class="comparison-box">
                    <div class="comparison-label">Enhanced Image</div>
        ...
        <div class="samples-section" id="sampleSection">
            ...
            <div class="d-flex justify-content-center mt-2">
                <div class="thumbnail-container">
                    <img class="sample-img" data-sample="sample1" name="women-2"
                ...
                <div class="thumbnail-container">
                    <img class="sample-img" name="man-2" data-sample="sample4"
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.sample-img', function() {
                ...
                setTimeout(function() {
                    ...
                    processedImage.attr('src', `/assets/images/${sampleName}.jpg`);
                    downloadBtn.attr('href', `/assets/images/${sampleName}.jpg`);
                    uploadSection.hide();
                    resultSection.show();
                }, 7000);
            });
